...
public class InputDataHandling {
    ...
    private void isNumbers(String input) throws IllegalArgumentException {
        if (input.equals("")) {
        ...
        if (isRoman(numbers[0]) && isRoman(numbers[1])) {
            firstNumber = RomanNumbers.convertToArabic(numbers[0]);
            secondNumber = RomanNumbers.convertToArabic(numbers[1]);
    ...
    private void isOperationLegal(String input) throws IllegalArgumentException {
